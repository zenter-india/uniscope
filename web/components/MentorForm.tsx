...
// original curated-top-30-+-"Other" pattern. DM-MCh/Diploma haven't been
// asked for this treatment yet, so they stay on the old pattern.
const BROWSE_DEGREES = new Set(["MD/MS", "DNB"]);
