    ...
    return (
      <div className="max-w-[620px] mx-auto mt-8 bg-surface border border-border rounded-[22px] p-8 text-center shadow-[0_30px_60px_-34px_rgba(16,27,59,.3)]">
        ...
        <button
          type="button"
          onClick={exit}
          className="mt-4 inline-flex items-center rounded-[9px] border-[1.5px] border-gold-500 text-gold-600 font-bold text-[13.5px] px-3.5 py-2"
        >
          Back to top
        </button>
      </div>
    ...
    >
      ...
      <div className="flex gap-2.5 mt-6">
        <button
          type="button"
          onClick={wizard.back}
          className={`flex-1 rounded-[11px] border-[1.5px] border-gold-500 text-gold-600 font-bold text-[14.5px] py-3 ${
        ...
        <button
          ...
          onClick={handleNext}
          disabled={submitting}
          className="flex-1 rounded-[11px] bg-gold-500 text-white font-bold text-[14.5px] py-3 disabled:opacity-60 shadow-[0_8px_20px_-8px_rgba(201,150,47,.55)]"
        >
