 ...
 * four-feature strip beneath it. Full-bleed, no side margin and no corner
 * radius on the photo itself — same reasoning as HeroCold: the section's
 * own dark background matched the photo's tone, so a margin only exposed
 * flat background instead of more photo. */
