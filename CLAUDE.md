...
> **Naming:** The product was renamed **MedConnect → Uniscope**. The repo, root
> `package.json`, and recent commits use Uniscope; much of `docs/` still says
> MedConnect. **Use "Uniscope" in all new code, copy, and docs.** A repo-wide
> doc rename is a pending chore — until then, treat MedConnect as a legacy alias.
...
3. Use "Uniscope" in new code/copy; don't propagate "MedConnect".
